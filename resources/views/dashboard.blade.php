...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <div class="logo">
                <h2><i class="fas fa-chart-line"></i>Wellcome {{Auth::user()->name}}</h2>
            </div>
            <div class="nav-links">
                <a href="#" class="nav-item active">
                    <i class="fas fa-home"></i> Dashboard
                </a>
                {{-- used gets method in blade to show specific --}}
        ...
        <div class="main-content">
            ...
            <div class="header">
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('profile.show', Auth::id()) }}" class="header-btn" style="text-decoration: none">
                        <i class="fas fa-user"></i> Profile
                    </a>

                   <a href="{{ route('post.show', Auth::id()) }}" class="header-btn" style="text-decoration: none">
                     <i class="fas fa-file-alt"></i> Posts
                    </a>
